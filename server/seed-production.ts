    ...
    await db.insert(products).values([
      {
        ...
        images: ['/products/dyu-a1f-pro/1.png', '/products/dyu-a1f-pro/2.png'],
        category: 'Folding',
        inStock: true,
        stockQuantity: 3,
        isBestseller: true,
      ...
      },
      {
        ...
        images: ['/products/eleglide-m2/1.png', '/products/eleglide-m2/2.jpg'],
        category: 'Mountain',
        inStock: true,
        stockQuantity: 8,
        isBestseller: true,
      ...
      },
      {
        ...
        images: ['/products/engwe-engine-x/1.png', '/products/engwe-engine-x/2.png'],
        category: 'Folding',
        inStock: true,
        stockQuantity: 5,
        isBestseller: true,
      ...
      },
      {
        ...
        images: ['/products/eleglide-m1-plus/1.png', '/products/eleglide-m1-plus/2.png'],
        category: 'Mountain',
        inStock: true,
        stockQuantity: 6,
        isBestseller: true,
