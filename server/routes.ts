  ...
  app.post("/api/admin/sync-variants", async (req, res) => {
    try {
      ...
      const variantData = [
        ...
        { slug: "engwe-ep-2-3-0-boost", type: "Color", value: "Forest Green", price: "1149.99", stock: 5, image: "/products/engwe-ep-2-3-0-boost/1.jpg" },
        { slug: "engwe-ep-2-3-0-boost", type: "Color", value: "Black", price: "1149.99", stock: 5, image: "/products/engwe-ep-2-3-0-boost/3.jpg" },
      ];
